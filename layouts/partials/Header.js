...
const Header = () => {
  ...
  return (
    <header className="header">
      <nav className="container px-1 navbar sm:px-8">
        ...
        <div className="flex items-center space-x-4 xl:space-x-8">
          ...
          >
            ...
            <ul
              id="nav-menu"
              className="w-full navbar-nav md:w-auto md:space-x-1 lg:flex xl:space-x-2"
            >
              {main.map((menu, i) => (
          ...
          <button
            ...
            className="inline-flex items-center justify-center w-10 h-10 text-white bg-purple-600 rounded-full lg:hidden"
          >
            {showMenu ? (
              <svg className="w-4 h-4 fill-current" viewBox="0 0 20 20">
                <title>Menu Close</title>
