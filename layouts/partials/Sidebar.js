...
const Sidebar = ({ posts, categories, className }) => {
  ...
  return (
    <aside className={`${className} px-0 lg:px-6 lg:col-4`}>
      {about.enable && (
        <div className="relative p-6 text-center border rounded border-border dark:border-darkmode-border">
          <ImageFallback
            className="-z-[1]"
            src="/images/map.svg"
            fill={true}
          ...
          <Social
            className="justify-center mt-6 socials sidebar-socials"
            source={social}
          />
        </div>
      )}
      ...
      {/* categories widget */}
      {categories.enable && (
        <div className="p-6 mt-6 border rounded border-border dark:border-darkmode-border">
          <h4 className="mb-12 text-center section-title">
      ...
      {featured_posts.enable && (
        <div className="p-6 mt-6 border rounded border-border dark:border-darkmode-border">
          <h4 className="mb-12 text-center section-title">Featured</h4>
                ...
                .map((post, i, arr) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="inline-flex items-center text-xs font-secondary">
      ...
      {/* newsletter */}
      {newsletter.enable && (
        <div className="p-6 mt-6 text-center border rounded border-border dark:border-darkmode-border">
