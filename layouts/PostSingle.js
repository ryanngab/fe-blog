...
const PostSingle = ({
  ...
  return (
    <Base title={title} description={description}>
      <section className="mt-6 section single-blog">
            ...
            <div className="lg:col-8">
              <article>
                <div className="relative">
                  ...
                  <ul className="absolute flex flex-wrap items-center top-3 left-2">
                    {categories.map((tag, index) => (
                      <li
                        className="mx-2 inline-flex h-7 rounded-[35px] bg-purple-600 px-3 text-white"
                        key={"tag-" + index}
                      >
                        <Link
                ...
                <ul className="flex items-center space-x-4">
                  <li>
                    <Link
                      className="inline-flex items-center text-xs leading-3 font-secondary"
                      href="/about"
                    >
                  ...
                  <li className="inline-flex items-center text-xs leading-3 font-secondary">
                    <FaRegCalendar className="mr-1.5" />
                    {dateFormat(date)}
                  </li>
                </ul>
                <div className="mb-16 content">
