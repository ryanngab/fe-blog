...
const Home = ({
  ...
  return (
    <Base>
      {/* Banner */}
      <section className="relative pb-0 section banner">
        <ImageFallback
        ...
        <div className="container">
          <div className="flex-wrap-reverse items-center justify-center row lg:flex-row">
            ...
            <div className="mb-12 lg:mb-0 lg:col-8">
              ...
              {featured_posts.enable && (
                <div className="section">
                  ...
                  <div className="p-6 border rounded border-border dark:border-darkmode-border">
                    <div className="row">
              ...
              {/* Promotion */}
              {promotion.enable && (
                <Link href={promotion.link} className="block pt-0 section">
                  <ImageFallback
              ...
              {recent_posts.enable && (
                <div className="pt-0 section">
                  ...
                  <div className="px-6 pt-6 border rounded border-border dark:border-darkmode-border">
                    <div className="row">
